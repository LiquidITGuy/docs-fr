...
L'erreur ci-dessus peut se produire si le chemin vers votre dossier de projet contient `*`, qu'esbuild traite comme un glob. Vous devrez renommer votre répertoire pour supprimer le `*`.
